  ...
  <g class="moon">
    ...
    <g><path fill="#acacac" stroke="#B5B5B6" stroke-miterlimit="10" d="M200.8 369.5c-.2.6-.8 1-1.4.8l-.9-.2c-.6-.2-1-.8-.8-1.4l25.5-89.5c.2-.6.8-1 1.4-.8l.9.2c.6.2 1 .8.8 1.4l-25.5 89.5z"/>
      ...
      {/* <!-- #F9DA1E --> */}
        ...
        {/* <img
          id="surveySatellite"
          src="https://thumbs.dreamstime.com/b/error-page-message-not-found-template-website-design-space-theme-icons-small-rockets-astronaut-spaceship-sputnik-null-102178057.jpg"
