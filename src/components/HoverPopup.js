...
const HoverPopUp = (props) => {
  ...
  if ((planetType === 'rocky' || planetType === 'earthLike') && planetSize <= 2)
  ...
  const planetTypeInfo = {
    ...
    Neptunian:
      'These exoplanets are similar in size to Neptune or Uranus in our solar system. Neptunian planets typically have hydrogen and helium-dominated atmospheres with cores or rock and heavier metals',
    Super_Earth:
      'A class of planets unlike any in our solar system – are more massive than Earth yet lighter than ice giants like Neptune and Uranus, and can be made of gas, rock or a combination of both. They are between twice the size of Earth and up to 10 times its mass.',
    Gas_Giant:
      'Large planets mostly composed of helium and/or hydrogen. These planets, like Jupiter and Saturn in our solar system, don’t have hard surfaces and instead have swirling gases above a solid core. Gas giant exoplanets can be much larger than Jupiter, and much closer to their stars than anything found in our solar system.',
  };

  const renderText = () => {
    return (
      <div className="popupRenderText">
  ...
  return (
    <div className="popupTextWrapper">
      ...
      >
        Planet Type:{' '}
        {planetType.includes('_')
          ? planetType.split('_').join(' ')
          : planetType}
        {text}
      </div>
    </div>
