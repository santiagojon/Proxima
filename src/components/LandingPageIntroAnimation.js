...
// export const LandingPageIntroAnimation = () => {
//   //useEffect for getContext?
...
//   useEffect(() => {
//     const canvas2 = document.createElement("introAnimation"),
...
//       const radius = random(60, this.orbitRadius) / 12;
//       const orbitX = w / 2;
//       const orbitY = h / 2;
//     });

//     const timePassed = random(0, maxStars);
//     const speed = random(this.orbitRadius) / 50000;
...
//     return <canvas id="introAnimation">{animation()}</canvas>;
//   };
// };
